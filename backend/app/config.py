...
class Topics:
    ...
    # Vehicle energy must come from a real BMS, not the total-station battery.
    # Integrators may override this topic with XLINE_VEHICLE_BATTERY_TOPIC.
    vehicle_battery_state: str = os.getenv(
        "XLINE_VEHICLE_BATTERY_TOPIC", "/battery_state"
    ).strip() or "/battery_state"
