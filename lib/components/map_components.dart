...
class _MapPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final scale = (size.width - margin * 2) / worldWidth;
    final scaleY = (size.height - margin * 2) / worldHeight;
    final pixelsPerMeter = scale < scaleY ? scale : scaleY;
    final mapWidth = worldWidth * pixelsPerMeter;
    final mapHeight = worldHeight * pixelsPerMeter;
