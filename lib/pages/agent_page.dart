            ...
            children: [
              ...
              DropdownButtonHideUnderline(
                child: DropdownButton<String>(
                  ...
                  items: const [
                    DropdownMenuItem(value: 'base', child: Text('基础模式')),
                    DropdownMenuItem(value: 'advanced', child: Text('进阶模式')),
                  ],
                  onChanged: _sending
                      ? null
                      : (value) {
              ...
              if (_agentMode == 'base') ...[
                ...
                Tooltip(
                  message: _printerConnected
                      ? '基础模式喷墨：$_printerSprayLabel。打开后可边控制小车边喷墨'
                      : '喷码机未连接',
                  child: Row(
